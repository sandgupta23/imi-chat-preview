...
var EmployeeReply = function () {
  ...
  EmployeeReply.prototype.getTemplate = function (text, source, bodyKey, txn, employee, isModal) {
    var _this = this;
    ...
    var htmlStr = "\n                <div class=\"employee-card shadow-theme " + (isPhone === 'true' ? 'view-phone' : '') + "\" " + (isModal === 'true' ? 'view-modal' : '') + "\">\n                        <div class=\"employee-card-header\">\n                            <div class=\"pic\">\n                                <img src=\"https://imibot-dev.s3.amazonaws.com/default/defaultbotlogo.png\" alt=\"\">\n                            </div>\n                            <div class=\"header-info\">\n                                <div class=\"title\">" + employee.header.name + "</div>\n                                <div class=\"description\">" + employee.header.jobtitle + "</div>\n                            </div>\n                         </div>\n                        <div class=\"employee-card-body\">\n                            " + bodyKey.map(function (key) {
      return _this.getModalBlockForKey(employee, key);
    }).join('') + "\n                        </div>\n                        <div class=\"employee-card-footer\">\n                                <button data-txn=\"" + txn + "\" class=\"open-modal\" rel=\"modal:open\" class=\"open-modal\">More Info</button>\n                        </div>\n                    </div>\n                \n            ";
    return htmlStr;
  };

  EmployeeReply.prototype.getModalBlockForKey = function (employee, key) {
    return "<div class=\"info\">\n<h1 class=\"info-title\" style=\"display: none\">" + key + "</h1>\n                                        " + this.getRows(employee[key]) + "\n                                </div>";
  };

  EmployeeReply.prototype.getElement = function (text, source, bodyKey, txn, employee, isModal) {
    var str = this.getTemplate(text, source, bodyKey, txn, employee, isModal);
    return utility_1.convertStringToDom(str);
  };
...
function AppendMessageInChatBody(messages, botResponse, hideFeedback) {
  ...
  if (messages[0].SESSION_EXPIRY) {
    ...
    if (botResponse && botResponse.room.df_state.emp_card) {
      var employee = botResponse.room.df_state.emp_card;
      var s = new employee_1.EmployeeReply(botResponse.room.df_state.emp_card);

      var flattenEmployee = __assign(__assign({}, employee), employee.remaining_parameters);

      var employeeTemplate = s.getElement('', send_api_1.ESourceType.bot, ['small_card_description'], botResponse.transaction_id, flattenEmployee);
...
function initClientEvents(imiPreview) {
  try {
    ...
    dom_1.$envOptions && dom_1.$envOptions.addEventListener('click', function ($event) {
...
function getEmployeeModal() {
  ...
  return "\n        " + s.getTemplate('', send_api_2.ESourceType.bot, ['general', 'profile']) + " \n    ";
}
...
function initEvents(imiPreview) {
  ...
  dom_1.$chatBody.addEventListener('keyup', function ($event) {
    ...
    if ($event.target.classList.contains('open-modal')) {
      ...
      var employee = res.room.df_state.emp_card;

      var flattenEmployee = __assign(__assign({}, employee), employee.remaining_parameters);

      flattenEmployee.general = __assign(__assign({}, flattenEmployee.general), flattenEmployee.small_card_description);
      var isModal = true;
      var x = new employee_1.EmployeeReply(employee).getTemplate('', send_api_2.ESourceType.bot, ['general', 'profile'], txn, flattenEmployee, isModal);
