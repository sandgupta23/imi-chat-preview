...
exports.environment = {
  ...
  bot_unique_name: "carona",
  enterprise_unique_name: "demos",
  root: "",
  consumer: {
...
function initClientEvents(imiPreview) {
  try {
    ...
    dom_1.$chatInput && dom_1.$chatInput.addEventListener('keypress', function ($event) {
      if ($event.key === 'Enter') {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          brandColor = "_1A5EB4";
          utility_1.getQueryStringValue('brandcolor') || "#2b4f70";
